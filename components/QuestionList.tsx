        ...
        <div key={idx} className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow">
          <div className="p-5 border-b border-slate-100 flex justify-between items-start bg-slate-50/50">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-slate-800">{q.category}</h3>
                <span className={`text-xs px-2 py-0.5 rounded-full font-medium ${
                  q.difficulty === 'Expert' ? 'bg-red-100 text-red-700' :
          ...
          <div className="p-6 space-y-4">
            <div>
              ...
              <p className="text-slate-800 text-lg leading-relaxed">{q.scenario}</p>
            </div>
